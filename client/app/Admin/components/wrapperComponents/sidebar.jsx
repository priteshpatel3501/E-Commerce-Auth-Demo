          ...
          <ul className="nav" id="side-menu">
            ...
            {/* <li>
              <NavLink exact activeClassName="waves-effect active" to="/home">
                <i className="icon-clock fa-fw" data-icon="v" />
            ...
            <li>
              <NavLink exact activeClassName="waves-effect active" to="/users">
            ...
            {/* <li>
              <NavLink exact activeClassName="waves-effect active" to="/order">
                <i className="icon-drawar fa-fw" data-icon="v" />
